...
THEN
	...
	THEN
			...
			THEN
				IF @SESSIONLIMIT >= @CURRENTSESSIONSALES OR @CURRENTSESSIONSALES IS NULL -- WHEATHER THE AMOUNT OF FOOD PREPARED HAS BEEN EXCEEDED OR WE CAN PROVIDE MORE FROM STOCK
				THEN
...
/*CALL SINGLEORDERSPROCEDURE('COFFEE', 3, @ERROR, @COMMENTS);
SELECT @ERROR;
